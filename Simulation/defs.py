...
nsim = 5                #num simulations in a run
...
nbatch_d = 10000       #num labels in dis batch
nbatch_g = 10000       #num labels in gen batch
...
nsamp = 10000          #num samples in training gaussians
...
ycov_change_linear_max_factor = 1.   #max change in growth in y
